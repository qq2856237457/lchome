...
// 添加评论
export const reqAddComment=(comment)=>ajax(BASE+'/manage/addcomment',comment,"POST");
...
// 管理员添加头条文章
export const reqAddMsg=(title,context)=>ajax(BASE+'/admin/addmsg',{title,context},"POST");
